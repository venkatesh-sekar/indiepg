...
func TestDefaultRules(t *testing.T) {
	...
	for _, want := range []string{"pg-down", "disk-headroom-low", "disk-almost-full", "backup-stale", "backup-failed", "connections-near-max", "connections-critical", "replication-lag-high"} {
